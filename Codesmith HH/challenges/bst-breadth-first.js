...
//input bst
//output calling cbs on the bst breadth first

//create an array consisting of root.value
//while loop (condition is array.length)
  //if array[0].left, push
  //if array[0].right, push
  //invoke cb on array.sh
